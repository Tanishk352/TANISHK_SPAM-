...
HELP_STRING = f"★ 𝐔sᴇʀ𝐃ɪᴇᴅ_ 𝐗_ 𝐒ᴘᴀᴍ 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @TANISHK352**"
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own 𝐔sᴇʀ𝐃ɪᴇᴅ_ 𝐗_ 𝐒ᴘᴀᴍ Bots !! @TANISHK352", cache_time=0, alert=True)
