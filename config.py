...
API_ID = 25616795
API_HASH = "0f4d18a0cb5c4562aca6a6f42fe9f6a7"
CMD_HNDLR = getenv("CMD_HNDLR", default=".")
HEROKU_APP_NAME = getenv(" __𝐔sᴇʀ𝐃ɪᴇᴅ_ 𝐗_ 𝐒ᴘᴀᴍ__", None)
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="6968339179").split()))
for x in ALTRON:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="5212854085"))
